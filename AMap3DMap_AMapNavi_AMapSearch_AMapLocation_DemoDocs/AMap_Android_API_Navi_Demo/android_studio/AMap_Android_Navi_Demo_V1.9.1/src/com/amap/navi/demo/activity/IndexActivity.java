...
public class IndexActivity extends Activity {
    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position == 0) {
                ...
                startActivity(new Intent(IndexActivity.this, CustomDirectionViewActivity.class));
            } else if (position == 17) {
                startActivity(new Intent(IndexActivity.this, CustomTrafficButtonViewActivity.class));
            } else if (position == 18) {
                startActivity(new Intent(IndexActivity.this, CustomNextTurnTipViewActivity.class));
            } else if (position == 19) {
                startActivity(new Intent(IndexActivity.this, CustomZoomButtonViewActivity.class));
            } else if (position == 20) {
                ...
                startActivity(new Intent(IndexActivity.this, CustomOverviewButtonViewActivity.class));
            }
    ...
    private String[] examples = new String[]
            ...
            {
                    "基本导航页", "自定义路段", "自定义路口放大图", "自定义道路选择", "HUD显示", "智能播报", "路径规划", "实时导航", "自定义路况蚯蚓线", "多路径规划", "展示导航路径详情", "正北模式", "查看全览", "步行导航", "主辅路", "使用外部GPS数据", "自定义指南针", "自定义路况按钮", "自定义下路口转向提示", "自定义放大缩小按钮", "自定义车辆", "自定义AMapNaviView中的路线纹理", "自定义全览按钮"
            };
