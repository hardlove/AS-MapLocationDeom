...
public class RestRouteShowActivity extends Activity implements AMapNaviListener, OnClickListener, OnCheckedChangeListener {
	private boolean congestion, cost, hightspeed, avoidhightspeed, multipleroute;
	/**
	 * 导航对象(单例)
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CheckBox multipleroute = (CheckBox) findViewById(R.id.multipleroute);
		...
		multipleroute.setOnCheckedChangeListener(this);
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		...
		case R.id.hightspeed:
			...
			break;
		case R.id.multipleroute:
			multipleroute = isChecked;
			break;
		default:
			break;
		}
	...
	public void onClick(View v) {
		...
		case R.id.calculate:
			...
			int strategyFlag = 0;
			try {
				strategyFlag = mAMapNavi.strategyConvert(congestion, avoidhightspeed, cost, hightspeed, multipleroute);
			} catch (Exception e) {
				e.printStackTrace();
			}
			if (strategyFlag >= 0) {
